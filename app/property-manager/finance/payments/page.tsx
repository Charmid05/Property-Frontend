...
export default function PropertyManagerPaymentsPage() {
      ...
      accessor: (row: Payment) =>
        row.receipt ? (
          <button
            onClick={(e) => {
              e.stopPropagation();
              router.push(`/property-manager/finance/receipts/${row.receipt}`);
            }}
    ...
    <div className="p-6 bg-white min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track payments from your properties
          </p>
        </div>
        <ActionButton
          onClick={() => router.push("/property-manager/finance/payments/new")}
          icon={Plus}
          variant="primary"
        >
          Record Payment
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200">
        <DataTable
          ...
          columns={columns}
          isLoading={isLoading}
          emptyMessage="No payments found for your properties"
        />
      </div>
